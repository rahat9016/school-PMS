          ...
          <div className="w-full lg:w-1/2 xl:w-5/12">
            ...
            <div className="mt-7">
              <p className="text-sm lg:text-base font-light font-poppins text-darkGray -mt-7">
                The Parents & Faculty Community (PFC) Leadership at Pan-Asia
                International School fosters strong collaboration between
                parents and staff. This dedicated team supports school events,
                encourages open communication, and works to enhance the student
                experience. United by a shared commitment to student success,
                PFC leaders help build a connected and caring school community.
              </p>
              <div className="flex items-end">
                <p className="text-sm xl:text-base font-medium font-poppins text-darkGray mt-2">
                  Whether it’s coordinating cultural celebrations, supporting
                  academic programs, or lending a hand during school activities,
                  the PFC Leadership team believes in the power of partnership.
                  Together, we aim to create a nurturing space where every
                  student can thrive.
                </p>
              </div>
            </div>

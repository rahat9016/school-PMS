...
export default function SchoolCounsellingSection() {
  return (
    <div className="bg-white pt-10 lg:pt-32 pb-[104px]">
      <div className="container">
        <div className="flex flex-col lg:flex-row gap-6 mt-14">
          <div className="w-full lg:w-1/2">
            <TitleTag title="Counselling" />
            <h1 className='text-5xl text-black font-poppins font-semibold mt-8'>School Counselling</h1>
            <p className="text-base font-poppins text-darkGray font-normal mt-14 leading-[28px]">
          ...
          >
            <Image src={SchoolCounsellingImg} alt="School Counselling Img" width={590} height={410} />
          </div>
        </div>
      </div>
    </div>

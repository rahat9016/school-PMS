    ...
    <div className="bg-white py-12 md:py-32">
      ...
      <div className="relative md:w-1/2">
        ...
        <Image
          src={aboutUsImg3}
          alt="aboutUsImg3"
          className="absolute top-[36%] left-[54%] transform -translate-x-1/2 -translate-y-1/2 animate-zoom-in-out"
          width={74}
          height={77}
        />
      </div>
      ...
      <div className="lg:text-left md:w-1/2">
        ...
        <h2 className="text-xl lg:text-5xl font-semibold font-poppins lg:leading-[58px] mt-6 md:mt-12">
          Pan Asia
          <br /> International School
        </h2>
        <p className="text-gray-600 mb-6 md:mb-12 mt-7 md:mt-14 text-darkGray font-poppins font-light leading-[24px]">
        ...
        <p className="text-gray-600 mb-6 md:mb-[60px] text-darkGray font-poppins font-light leading-[24px] ">

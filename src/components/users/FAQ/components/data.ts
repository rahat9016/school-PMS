...
export const data = [
  ...
  {
    title: "What extra-curricular activities are available for my child?",
    desc1:
  ...
  {
    title: "Can my child study at a Thai university after receiving a high school diploma at PAIS (Grade 12)?",
    desc1:
  ...
  {
    title: "What makes PAIS different from other international schools/programs?",
    desc1:
  ...
  {
    title: "What are the advantages of receiving an IB Diploma or Certificate?",
    desc1:
  ...
  {
    title: "What do universities think about the IB?",
    desc1:
  ...
  {
    title: "Are all of PAIS teachers fully certified?",
    desc1:
